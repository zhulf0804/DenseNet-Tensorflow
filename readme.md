## About
Tensorflow implementation of [DenseNet](http://openaccess.thecvf.com/content_cvpr_2017/papers/Huang_Densely_Connected_Convolutional_CVPR_2017_paper.pdf), the prediction accuracy on 10,000 test images is **88.8%**(**paper: 93%**).
...
on batch size: 100, test accuracy: 0.870000
on batch size: 100, test accuracy: 0.860000
The test set number is 10000, the average accuracy is 0.887800
```